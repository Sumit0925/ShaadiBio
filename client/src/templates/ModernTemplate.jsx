...
/*
 * Item — icon + label + value stack.
 * Pure flex column. No grid. Explicit widths on parent containers.
 */
function Item({ icon, label, value }) {
  ...
  return (
    ...
    >
      <span
        style={{ fontSize: 13, minWidth: 18, flexShrink: 0, lineHeight: 1.4 }}
      >
        {icon}
      </span>
...
/*
 * Section — heading + two-column layout using two flex divs side-by-side.
 * NO CSS grid — grid 1fr columns collapse in html2canvas.
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Quick stats — each as a flex row */}
        <div style={{ width: "100%" }}>
          {[
            ...
            .map((stat, i) => (
              <div
                ...
                style={{
                  ...
                  alignItems: "flex-start",
                  padding: "4px 0",
                  borderBottom: "1px solid rgba(124,200,224,0.15)",
                  width: "100%",
                  boxSizing: "border-box",
                }}
              >
      ...
      >
        ...
        <Section title="Education & Career">
          ...
          {!data.hideIncome && (
            <Item icon="💰" label="Income" value={data.income} />
          )}
        </Section>
